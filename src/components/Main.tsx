          ...
          {survey.map((item) => (
            <article className="answer">
              ...
              <p>
                ...
                {item.bestFeatures.map((feature) => (
                  <span className="answer__line">{feature}</span>
                ))}
              </p>
              <p>
                <em>
                  What would you say that are the worst nags of your rubber
                  duck?
                </em>
                {item.worstFeatures.map((feature) => (
                  <span className="answer__line">{feature}</span>
                ))}
              </p>
              <p>
